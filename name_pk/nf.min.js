...
function checkResult(m) {
	"undefined" == typeof WeixinJSBridge ? $("#rancat").attr("href", "https://guole.fun/game/") : $("#rancat").attr("href", "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx44f60c4714e27147&redirect_uri=http%3a%2f%2f345.gd%2fnf%2f&response_type=code&scope=snsapi_base&state=1126#wechat_redirect");
	var p = "";
	0 >= a.hp ? ($("#resultbg").css("background-image", "url(img/lose.jpg)"), p = "\u80dc\u8d25\u4e43\u5175\u5bb6\u5e38\u4e8b\uff0c<br>\u5927\u4fa0\u8bf7\u91cd\u65b0\u6765\u8fc7!", des = "\u6211\u88ab[" + d.name + "]\u6253\u8d25\u4e86\uff0c\u5c0f\u4f19\u4f34\u4eec\u5feb\u6765\u5e2e\u6211\u62a5\u4ec7TAT", url = "https://guole.fun/game/?d=" + encodeURIComponent(d.name)) : ($("#resultbg").css("background-image", "url(img/win.jpg)"), p = "\u606d\u559c\u60a8\u5728<span class='ahurt'>" + m + "</span>\u56de\u5408\u5185\u89e3\u51b3\u4e86<span class='" + d.part + "name'>[" + d.name + "]</span>\uff0c\u5feb\u53bb\u627e\u5c0f\u4f19\u4f34\u4eec\u70ab\u8000\u5427\uff01", des = "\u6211[" + a.name + "]\u5728" + m + "\u56de\u5408\u5185\u89e3\u51b3\u4e86[" + d.name + "]\uff0c\u8c01\u6562\u4e0e\u6211\u4e00\u6218\uff01", url = "https://guole.fun/game/?d=" + encodeURIComponent(a.name));
...
function WeiXinShareBtn() {
	"undefined" == typeof WeixinJSBridge ? alert(" \u53ea\u6709\u5728\u5fae\u4fe1\u6d4f\u89c8\u5668\u4e2d\u624d\u80fd\u5206\u4eab\u54e6 :) ") : (WeixinJSBridge.invoke("shareTimeline", {
		img_url: "https://guole.fun/game/nfbt.png",
		link: url,
		desc: des,
		title: des
